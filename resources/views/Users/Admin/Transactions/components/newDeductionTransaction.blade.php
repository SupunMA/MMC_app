        ...
        <form action="{{route('admin.addingTransaction')}}" method="post">
            ...
            <div class="card card-danger">
                <div class="card-header">
                    <h3 class="card-title">Cut off Debt</h3>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2bs4" style="width: 100%;" name="transLoanID">
                                    ...
                                    <option value="{{$data->loanID}}">Loan</option>
                                    <option value="{{$data->loanID}}">Interest</option>
                                    <option value="{{$data->loanID}}">Late Fees</option>
